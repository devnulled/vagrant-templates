...
WL_HOME="/opt/weblogic/wls12120/wlserver"
export WL_HOME
...
SUN_JAVA_HOME="/usr/lib/jvm/java-7-oracle/jre"
export SUN_JAVA_HOME

DEFAULT_SUN_JAVA_HOME="/usr/lib/jvm/java-7-oracle/jre"
...
LONG_DOMAIN_HOME="/opt/weblogic/domain"
