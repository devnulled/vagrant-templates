...
usage()
{
	...
	echo "ADMIN_URL defaults to t3://precise32:7001 if not set as an environment variable or the second command-line parameter."
	...
	echo "for example:"
	echo "$1 managedserver1 t3://precise32:7001 weblogic weblogic"
}
...
DOMAIN_HOME="/opt/weblogic/domain"
