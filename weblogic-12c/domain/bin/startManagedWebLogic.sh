...
usage()
{
	...
	echo "for example:"
	echo "$1 managedserver1 http://precise32:7001"
}
...
JAVA_OPTIONS="-Dweblogic.security.SSL.trustedCAKeyStore="/opt/weblogic/wls12120/wlserver/server/lib/cacerts" ${JAVA_OPTIONS}"
export JAVA_OPTIONS
